#!/usr/bin/env python3
#Checksum verifier. Verifies that two copies of the same file have the same MD5 checksum. Can be used to verify that a file has been accurately and completely copied to another location.
